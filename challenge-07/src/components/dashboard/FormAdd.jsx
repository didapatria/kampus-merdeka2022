    ...
    <div className='mt-16 flex-1 bg-gray-100 p-8 overflow-y-scroll'>
      ...
      <div className='bg-white rounded-sm p-4 space-y-4'>
        <div className='flex items-center space-x-2'>
          ...
          <div className='w-1/3 bg-white border border-gray-500 rounded-sm px-3 py-2'>Placeholder</div>
        </div>
        <div className='flex items-center space-x-2'>
        ...
        <div className='flex items-center space-x-2'>
          ...
          <div className='w-1/3 space-y-1'>
            <div className='bg-white border border-gray-500 rounded-sm px-3 py-2'>
